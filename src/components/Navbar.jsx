  ...
  return (
    <nav
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={logo} width={308} height={304} alt="logo" className="w-9 h-9 object-contain" />
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          {navLinks.map((link) => (
            ...
            "font-poppins font-medium cursor-pointer hover:text-white text-[16px] font-medium cursor-pointer"  
            }
            onClick={() => 
              { 
                setToggle(!toggle);
